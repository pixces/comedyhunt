...
<head>
	...
	<link rel="stylesheet" href="css/vendor/owl.carousel.css" type='text/css' />
	<link rel="stylesheet" href="css/vendor/owl.theme.css" type='text/css' />
	<link rel="stylesheet" href="css/vendor/owl.transitions.css" type='text/css' />
		...
		<div class="CH-NavWrapper">
			<div class="CH-Navigation">
				...
				<div class="CH-MainMenu">
					...
					<ul>
						<li><a href="javascript:void(0)" class="active transition">Home</a></li>
						<li><a href="javascript:void(0)" class="transition">Gallery</a></li>
						<li><a href="javascript:void(0)" class="transition">Faq's</a></li>
						<li class="no-border"><a href="javascript:void(0)" class="transition">Rules</a></li>
					</ul>
				</div>
				<!-- Main Menu Ends Here -->
		...
		<div class="CH-TimeLine">
			...
			<div class="CH-CompetitionTimeline">
				...
				<div class="CH-TimelineRules">
					<div class="CH-TimelineRulesImage"><img src="images/competition-timeline.png" class="img-responsive" /></div>
					<div class="CH-Phase1">
