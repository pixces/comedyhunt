...
class Content extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('user_name, user_email, title, description, type','required'),
            array('is_ugc', 'numerical', 'integerOnly' => true),
            array('user_name, author, channel_name', 'length', 'max' => 150),
            array('user_email, title, media_url, thumb_image, alternate_image', 'length',
                'max' => 255),
            ...
            array('id, user_name, user_email, title, description, media_id, media_url, type, author, channel_name, is_ugc, thumb_image, alternate_image, status, date_created, date_modified',
                'safe', 'on' => 'search'),
        );
    }
