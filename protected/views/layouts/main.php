			...
			<div class="CH-Navigation">
				...
				<div class="CH-MainMenu">
					...
					<ul>
                        ...
                        <li><a href="<?=Yii::app()->createAbsoluteUrl('/gallery/'); ?>" class="<?=($this->pagename == 'gallery') ? 'active ':''; ?>transition">Entries</a></li>
                        <li><a href="<?=Yii::app()->createAbsoluteUrl('/site/faq/'); ?>" class="<?=($this->pagename == 'faq') ? 'active ':''; ?>transition">Comedy 101</a></li> 
