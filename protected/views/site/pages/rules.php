        ...
        <div class="CH-RulesList">
            <div class="CH-RulesBlk">
                <div class="scroll-pane">
					...
					<p>This  Programme is called &ldquo;Quikr presents Comedy Hunt on YouTube, Laughs powered by  Micromax, Wisecracks by Cadbury 5-Star &amp; Garnier Men&rdquo;, here-in-after  referred to as &ldquo;Comedy Hunt&rdquo;.</p>
					<p>Comedy  Hunt is property owned, administered and promoted by OML Entertainment Private  Limited, herein after referred to as &ldquo;Promoter&rdquo;. &nbsp;Since  submission of entry constitutes acceptance of these Entry Rules &amp;  Regulations, please review this document carefully.</p>
					...
					<ul>
					  ...
					  <li>Register/log-in  through their existing YouTube ID and upload the entry video on their own YouTube  channel. Participant should name their entry video as &ldquo;Comedy Hunt – <em>entry video title</em>&rdquo;, where entry video  title refers to the unique name that the participant wishes to give to the  entry video. Participant should review the Creative Toolkit at <a href="http://www.youtube.com/thecomedyhunt" target="_blank">www.youtube.com/thecomedyhunt</a> for use in the entry  video.</li>
					  <li>Submit  the entry video url at <a href="http://www.youtube.com/thecomedyhunt" target="_blank">www.youtube.com/thecomedyhunt</a>, along with their  name, and contact details </li>
					  <li>Click on I agree to the terms and  conditions, declaring that you hold the copyright for or have the right to use  this video, and agree to the video being used as described in the guidelines  for this competition.</li>
					</ul>
					...
					<p>Submissions  start on 1st July, 2015 and the last date for submissions is 21st  July, 2015 midnight (IST).</p>
